...
void CYarpCommunicationServerUpperLimb::PrepareHandProcessor()
{
	//start processor only if hand was hardware enabled
	if (hand)
		hand_processor = boost::thread(boost::bind(&CYarpCommunicationServerUpperLimb::HandExecutor, this));
}

void CYarpCommunicationServerUpperLimb::HandExecutor()
{
	double HandConfig[4];
	do
	{
...
bool CYarpCommunicationServerUpperLimb::HandCheckCommand(unsigned int cmd)
{
	switch (cmd)
	{
...
bool CYarpCommunicationServerUpperLimb::HandProcessor(CMessage &in_req, CMessage &out_reply, void *private_data )
{
...
bool CYarpCommunicationServerUpperLimb::Initialize(void)
{
...
bool CYarpCommunicationServerUpperLimb::InitJoint(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::isHandAvailable(void)
{
	size_t
		size_s = Spread.size(),
...
bool CYarpCommunicationServerUpperLimb::OpenJoint(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::Open(void)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::CloseJoint(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::Close(void)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::OpenTorqueJoint(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::OpenTorque(void)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::CloseTorqueJoint(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::CloseTorque(void)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetOpenTarget(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetCloseTarget(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::GetPositions(std::vector<float> &fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::GetOpenTarget(std::vector<float> &fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::GetCloseTarget(std::vector<float> &fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetOpenTargetJoint(int joint, double value)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetCloseTargetJoint(int joint, double value)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
float CYarpCommunicationServerUpperLimb::GetOpenTargetJoint(int joint)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
	double dAux = 0.0;
...
float CYarpCommunicationServerUpperLimb::GetCloseTargetJoint(int joint)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
	double dAux = 0.0;
...
bool CYarpCommunicationServerUpperLimb::SetVelocity(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::GetVelocity(std::vector<float> &fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetOpenVelocity(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetCloseVelocity(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::SetAcceleration(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::GetAcceleration(std::vector<float> &fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
	double dArrayAux[4];
...
bool CYarpCommunicationServerUpperLimb::SetMaxStrain(std::vector<unsigned int> iData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::GetMaxStrain(std::vector<unsigned int> &iData)
{
...
bool CYarpCommunicationServerUpperLimb::GetStrainGauge(std::vector<unsigned int> &uParam)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
void CYarpCommunicationServerUpperLimb::SetStrainGauge(bool ispicked1)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
	isPicked = ispicked1;
...
bool CYarpCommunicationServerUpperLimb::IncrementalMoveJoint(int joint, double value)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
bool CYarpCommunicationServerUpperLimb::IncrementalMove(std::vector<float> fData)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
void CYarpCommunicationServerUpperLimb::GetHandConfig(double dHandConfig[4])
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
void CYarpCommunicationServerUpperLimb::GetSpreadConfig(double &dHandConfig)
{
	boost::unique_lock<boost::mutex> lck(mutex_Command);
...
std::string CYarpCommunicationServerUpperLimb::Report_Error_at_Command(unsigned int uCommand)
{
...
std::string CYarpCommunicationServerUpperLimb::CommandToString(unsigned int uCommand)
{
